...
AppCloneTweeter es una app que simula el comportamiento de Twitter.

## Descripción

AppCloneTweeter busca simular el comportamiento de twitter en cuanto a su lógica de implementación y publicación de tweets.

## Visuales

![](app/assets/images/appCloneTweeter.png)

> Deployments: https://appclonetwitter-d410b7212497.herokuapp.com/
...
```bash
git clone
git@github.com:alexandraguilarc/appCloneTwitter.git
```
